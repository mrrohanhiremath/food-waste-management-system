...
$db = mysqli_select_db($connection, 'food-waste-management-system');
 include("connect.php"); 
if($_SESSION['name']==''){
...
<body>
    ...
    <section class="dashboard">
        ...
        <div class="top">
            ...
            <!-- <p>Food Donate</p> -->
            <p  class ="logo" >Akshara <b style="color: #06C167; ">Foundation</b></p>
             <p class="user"></p>
...
var xplace=["Bangalore","Mangalore","Mysore"];
var yplace=[<?php echo json_encode($Bangalore,JSON_HEX_TAG);?>,<?php echo json_encode($Mangalore,JSON_HEX_TAG);?>,<?php echo json_encode($Mysore,JSON_HEX_TAG);?>];
